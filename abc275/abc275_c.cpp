        ...
        rep0(j, P.size())
        {
            ...
            rep0(k, P.size())
            {
                ...
                rep0(l, P.size())
                {
                    ...
                    ll xj = P[j].first - xi, yj = P[j].second - yi;
                    ll xk = P[k].first - xi, yk = P[k].second - yi;
                    ll xl = P[l].first - xi, yl = P[l].second - yi;
                    xi = 0;
                    yi = 0;
                    if (xj * xk + yj * yk != 0)
                    {
                    ...
                    if (xj + xk != xl || yj + yk != yl)
                    {
                        continue;
                    }
                    if (xl * (xj - xk) + yl * (yj - yk) != 0)
                    {
                        continue;
                    }
                    // print(xi, yi);
